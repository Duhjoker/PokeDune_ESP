  ...
  for (uint16_t i = 0; i < tft.numcolision + 1; i++)
  {
    if (tft.collideRectRect(player.player_x, player.player_y, 16, 16, tft.solid[i].x, tft.solid[i].y, 16, 16))
    {
      if (tft.solid[i].spritecol == bedtop)return true;
        ...
        tft.Popup(F(" ""boulder"" "), 2, 60, 20);  //Return True if character have touched a boulder//return true;
        return true;
      }
      else if (tft.solid[i].spritecol == boulders) {
        tft.Popup(F(" ""boulders"" "), 2, 60, 20);  //Return True if character have touched boulders//return true;
        return true;
      }
      ...
      //   else if((tft.solid[i].spritecol == chest1) && player.room == 3 && (ButtonB.fallingEdge()) && item_1 == 1){tft.Popup(F(" ""You got key"" "),1,90,25); AddInv(water); getFirstAvailSlot(); return true;}
      
